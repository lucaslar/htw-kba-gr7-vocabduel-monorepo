...
public class ScoreAdministrationImplWinsTest {
    ...
    @Parameterized.Parameters(name = "{index}: getTotalWinsOfUser(\"{0}\")")
    ...
    public ScoreAdministrationImplWinsTest(final User user, final int wins) {
        this.user = user;
        this.wins = wins;
    }
    ...
    public void testWins() {
        Assert.assertEquals(scoreAdministration.getTotalWinsOfUser(user), wins);
    }
}
