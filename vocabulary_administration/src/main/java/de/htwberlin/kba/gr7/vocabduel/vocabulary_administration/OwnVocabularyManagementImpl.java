...
import de.htwberlin.kba.gr7.vocabduel.vocabulary_administration.export.OwnVocabularyManagement;
...
public class OwnVocabularyManagementImpl implements OwnVocabularyManagement {
    @Override
