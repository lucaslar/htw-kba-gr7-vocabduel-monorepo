...
public class VocabduelControllerImpl implements VocabduelController {
    ...
    private void onLoginCalled(final HashMap<String, String> args) {
        if (STORAGE.getLoggedInUser() != null) VIEW.printLogoutBeforeLogin(STORAGE.getLoggedInUser());
            ...
            } catch (UserOptimisticLockException | RuntimeException e) {
                e.printStackTrace();
            }
        }
    }
    ...
    private void onVocableImportCalled(final HashMap<String, String> args) {
        ...
        if (input != null) {
            ...
            } catch (DuplicateVocablesInSetException | IncompleteVocableListException | DataAlreadyExistsException | UnknownLanguagesException | InvalidVocableListException | VocabularyOptimisticLockException | RuntimeException e) {
                e.printStackTrace();
            }
        }
    }
    ...
    private void onRegistrationCalled(final HashMap<String, String> args) {
        if (STORAGE.getLoggedInUser() != null) VIEW.printLogoutBeforeLogin(STORAGE.getLoggedInUser());
            ...
            } catch (PasswordsDoNotMatchException | PwTooWeakException | InvalidOrRegisteredMailException | AlreadyRegisteredUsernameException | IncompleteUserDataException | InvalidNameException | UserOptimisticLockException | RuntimeException e) {
                e.printStackTrace();
            }
        }
    }
    ...
    private void onUpdateCalled(final HashMap<String, String> args) {
        ...
        if (args.get(ACTION_ARG_USERNAME) != null || args.get(ACTION_ARG_EMAIL) != null || args.get(ACTION_ARG_FIRSTNAME) != null || args.get(ACTION_ARG_LASTNAME) != null) {
            ...
            } catch (InvalidOrRegisteredMailException | AlreadyRegisteredUsernameException | IncompleteUserDataException | InvalidUserException | InvalidNameException | UserOptimisticLockException | RuntimeException e) {
    ...
    private void onUpdatePwdCalled(final HashMap<String, String> args) {
        ...
        } catch (InvalidFirstPwdException | PasswordsDoNotMatchException | PwTooWeakException | InvalidUserException | UserOptimisticLockException | RuntimeException e) {
            e.printStackTrace();
        }
    }
    ...
    private void onVocabListsCalled(final HashMap<String, String> args) {
        ...
        } catch (VocabularyOptimisticLockException | RuntimeException e){
            e.printStackTrace();
        }
    }
    ...
    private void onDeleteVocabListCalled(final HashMap<String, String> args) {
        ...
        } catch (DifferentAuthorException | VocabularyOptimisticLockException | RuntimeException e) {
            e.printStackTrace();
        }
    }
    ...
    private void onGameStarted(final HashMap<String, String> args) {
        ...
        } catch (NumberFormatException | UserOptimisticLockException e) {
        ...
        if (opponent != null) {
            ...
            } catch (NotEnoughVocabularyException | InvalidGameSetupException | InvalidUserException | UserOptimisticLockException
                     | VocabularyOptimisticLockException | GameOptimisticLockException | RuntimeException e) {
                e.printStackTrace();
            }
    ...
    private void onGameRoundAnswered(final HashMap<String, String> args) {
        ...
        if (Arrays.stream(options).noneMatch(v -> v.equals(args.get(ACTION_ARG_ANSWER)))) {
            ...
            if (gameId != null) {
                ...
                } catch (InvalidVocabduelGameNrException | NoAccessException | GameOptimisticLockException | RuntimeException e){
                e.printStackTrace();
                }
            }
        }
    ...
    private void onGameRoundStarted(final HashMap<String, String> args) {
        try {
            ...
            VIEW.printInvalidIdFormat(args.get(ACTION_ARG_ID));
        } catch (NoAccessException | GameOptimisticLockException | RuntimeException e) {
            e.printStackTrace();
        }
    }
    ...
    private void onGameListCalled() {
        ...
        } catch (GameOptimisticLockException | RuntimeException e){
            e.printStackTrace();
        }
    }
    ...
    private void onScoreHistCalled() {
        ...
        } catch (InvalidUserException | UserOptimisticLockException | GameOptimisticLockException | RuntimeException e) {
            e.printStackTrace();
        }
    }
    ...
    private void onUserDeleteCalled(final HashMap<String, String> args) {
        ...
        if (args.get(ACTION_ARG_CONFIRM) != null && args.get(ACTION_ARG_CONFIRM).equals("true")) {
            ...
            } catch (UserOptimisticLockException | GameOptimisticLockException | RuntimeException e) {
                e.printStackTrace();
            }
