...
public interface AuthService {
     ...
     */
    LoggedInUser registerUser(String username, String email, String firstname, String lastname, String password, String confirmPassword) throws PasswordsDoNotMatchException, PwTooWeakException, InvalidOrRegisteredMailException, AlreadyRegisteredUsernameException, IncompleteUserDataException, InvalidNameException, UserOptimisticLockException;
     ...
     * @throws UserOptimisticLockException An OptimisticLock error in the user module occurred.
     */
    LoggedInUser loginUser(String email, String password) throws UserOptimisticLockException;
     ...
     * @throws UserOptimisticLockException An OptimisticLock error in the user module occurred.
     */
    User fetchUser(String token) throws UserOptimisticLockException;
     ...
     * @throws UserOptimisticLockException An OptimisticLock error in the user module occurred.
     */
    AuthTokens refreshAuthTokens(String refreshToken) throws UserOptimisticLockException;
     ...
     * @throws UserOptimisticLockException An OptimisticLock error in the user module occurred.
     */
    boolean hasAccessRights(String token) throws UserOptimisticLockException;
     ...
     * @throws UserOptimisticLockException  An OptimisticLock error in the user module occurred.
     */
    int updateUserPassword(User user, String currentPassword, String newPassword, String confirmPassword) throws InvalidFirstPwdException, PasswordsDoNotMatchException, PwTooWeakException, InvalidUserException, UserOptimisticLockException;
}
